...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className=" bg-gray-900 py-10 flex justify-center items-center">
        <div className="container px-5 mx-auto flex justify-between items-center w-full">
          <div className=" text-xl">
            Download Project Report Files
          </div>
          <div className=" ">
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={()=>setToggleDrop(!toggleDrop)} className=" bg-indigo-500 text-white focus:ring-4 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center" type="button">Download Files <svg className="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
            <div id="dropdown" className={`z-10 ${(toggleDrop)?'block':'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
